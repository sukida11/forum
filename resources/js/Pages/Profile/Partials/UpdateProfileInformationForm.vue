    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Обновить вашу информацию о профиле и электронный адрес.
            </p>
        </header>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="nickname" value="Никнэйм" />
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-gray-800">
                    ...
                    >
                        Нажмите сюда, чтобы заново отправить письмо с подтверждением
                    </Link>
                </p>
                ...
                >
                    Новая ссылка была отправлена на вашу электронную почту.
                </div>
            </div>
